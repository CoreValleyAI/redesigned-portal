...
How to reach the CoreValley team, what to expect from support, and where service-level terms will be published.

!!! info "In progress"
    Service-level commitments are being finalised with commercial terms and will be published here. Until then, the [terms of service](https://corevalley.ai/legal/terms/) describe availability targets and maintenance windows.
